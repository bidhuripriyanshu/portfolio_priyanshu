...
// EmailJS Configuration — kept outside component so it's a stable module-level constant.
...
function ContactForm() {
  ...
  // Initialize EmailJS once on mount — EMAILJS_CONFIG is a stable module-level constant.
  useEffect(() => {
